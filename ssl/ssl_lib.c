...
struct ssl_async_args {
    ...
    union {
        int (*func_read) (SSL *, void *, size_t, size_t *, char* enc_data, int* enc_len);
...
static int ssl_io_intern(void *vargs)
{
    ...
    switch (args->type) {
    case READFUNC:
        return args->f.func_read(s, buf, num, &s->asyncrw, NULL, NULL);
    case WRITEFUNC:
...
int ssl_read_internal(SSL *s, void *buf, size_t num, size_t *readbytes, char* enc_data, int* enc_len)
{
    if (s->handshake_func == NULL) {
    ...
    if ((s->mode & SSL_MODE_ASYNC) && ASYNC_get_current_job() == NULL) {
        ...
        *readbytes = s->asyncrw;
        ...
        return s->method->ssl_read(s, buf, num, readbytes, enc_data, enc_len);
    }
}
...
int SSL_read(SSL *s, void *buf, int num)
{
    ...
    ret = ssl_read_internal(s, buf, (size_t)num, &readbytes, NULL, NULL);
...
int SSL_read_tor(SSL *s, void *buf, int num, char* enc_data, int* enc_len)
{
    int ret;
    size_t readbytes;
    ...
    ret = ssl_read_internal(s, buf, (size_t)num, &readbytes, enc_data, enc_len);
...
{
    int ret = ssl_read_internal(s, buf, num, readbytes, NULL, NULL);
...
static int ssl_peek_internal(SSL *s, void *buf, size_t num, size_t *readbytes)
{
    ...
    if ((s->mode & SSL_MODE_ASYNC) && ASYNC_get_current_job() == NULL) {
        ...
        *readbytes = s->asyncrw;
        ...
        return s->method->ssl_peek(s, buf, num, readbytes, NULL, NULL);
    }
}
