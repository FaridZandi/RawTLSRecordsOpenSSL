...
int ssl3_shutdown(SSL *s)
{
    ...
    if (!(s->shutdown & SSL_SENT_SHUTDOWN)) {
         ...
         */
        s->method->ssl_read_bytes(s, 0, NULL, NULL, 0, 0, &readbytes, NULL, NULL);
                              ...
                              size_t *readbytes, char* enc_data, int* enc_len)
{
    ...
    ret =
        s->method->ssl_read_bytes(s, SSL3_RT_APPLICATION_DATA, NULL, buf, len,
                                  peek, readbytes, enc_data, enc_len);
    if ((ret == -1) && (s->s3->in_read_app_data == 2)) {
        ...
        ret =
            s->method->ssl_read_bytes(s, SSL3_RT_APPLICATION_DATA, NULL, buf,
                                      len, peek, readbytes, enc_data, enc_len);
...
int ssl3_read(SSL *s, void *buf, size_t len, size_t *readbytes, char* enc_data, int* enc_len)
{
    return ssl3_read_internal(s, buf, len, 0, readbytes, enc_data, enc_len);
}

int ssl3_peek(SSL *s, void *buf, size_t len, size_t *readbytes, char* enc_data, int* enc_len)
{
    return ssl3_read_internal(s, buf, len, 1, readbytes, NULL, NULL);
}
