...
struct ssl_method_st {
    ...
    int (*ssl_read) (SSL *s, void *buf, size_t len, size_t *readbytes, char* enc_data, int* enc_len);
    int (*ssl_peek) (SSL *s, void *buf, size_t len, size_t *readbytes, char* enc_data, int* enc_len);
    ...
    int (*ssl_read_bytes) (SSL *s, int type, int *recvd_type,
                           ...
                           size_t *readbytes, char* enc_data, int* enc_len);
...
__owur int ssl_read_internal(SSL *s, void *buf, size_t num, size_t *readbytes, char* enc_data, int* enc_len);
...
__owur int ssl3_read(SSL *s, void *buf, size_t len, size_t *readbytes, char* enc_data, int* enc_len);
__owur int ssl3_peek(SSL *s, void *buf, size_t len, size_t *readbytes, char* enc_data, int* enc_len);
